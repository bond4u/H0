...
//demo();
module demo(){
    translate([-75,0]) drawCurveRocoR(2, 15);
    translate([-150,0]) drawStraightG(1/2);
}
...
module _straight(Length, DrawBaseFlag=1, DrawTrackFlag=1+2) {
    _length = Length;
...
// length in mm
module _plainStraight(length, DrawBaseFlag=1, DrawTrackFlag = 1+2) {
...
module curve(Radius, Angle, DrawBaseFlag=1, DrawTrackFlag=1+2) {
